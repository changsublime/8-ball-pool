...
The lights and shadows of our first implementation looked very polygonal and pixelated. We later found out that the problem was a low count of PixelLightCount, which is a project variable that we had not accounted for. After we increased the value, the night view of our pool game looks true to our inspiration.
